...
export const workExperiences: Experience[] = [
  {
    ...
    icon: "https://www.applift.xyz/_next/image?url=%2Fappliftlogo.png&w=96&q=100",
    description: [
  ...
  },
  {
    ...
    icon: "https://lawdam.xyz/favicon-32x32.png",
    description: [
  ...
  },
  {
    ...
    icon: "https://acadeva.xyz/icon.png",
    description: [
  ...
  },
  {
    ...
    icon: "https://thrivr-app-mu.vercel.app/favicon.png",
    description: [
  ...
  },
  {
    ...
    icon: "https://vistapayhq.com/icon.png",
    description: [
  ...
  },
  {
    ...
    icon: "https://teknart.vercel.app/favicon.png",
    description: [
  ...
  },
  {
    ...
    icon: "https://code30.vercel.app/favicon.ico",
    description: [
