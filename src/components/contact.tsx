import { EMAIL, WHATSAPP_URL } from "@/constants/globals";
    ...
    <footer className="py-16 border-t border-border mt-12">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 mb-4 rounded-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium transition-colors"
        >
